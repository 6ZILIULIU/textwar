...
export default class MsgPanel extends cc.Component {
    ...
    onReceiveInfo(infoType: string, infoStr: string) {
        this.displayInfo(infoType, infoStr);
    }
    ...
    displayInfo(infoType: string, infoStr: string) {
        let infoLabelNode = new cc.Node('info');
        infoLabelNode.setPosition(20, 0);
